...
function gameScreen.newGameScreen(xPos, yPos, width, height, left, right, flipped, layout)
    return GameScreen:new(xPos, yPos, width, height, left, right, flipped, layout)
end
